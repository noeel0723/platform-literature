...
Route::get('/literature', [LiteratureBrowseController::class, 'index'])->name('literature.index');
Route::get('/literature/browse', [LiteratureBrowseController::class, 'browse'])->name('literature.browse');
