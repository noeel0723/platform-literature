...
export default function GuestLandingHero({ literature, routes }) {
    ...
    return (
        <section className="relative min-h-[420px] overflow-hidden border-b border-brand-plate/10 bg-brand-stem text-brand-plate sm:min-h-[450px] lg:min-h-[480px]">
            {backdropUrl ? (
                <img
                    src={backdropUrl}
                ...
                <div
                    className="absolute inset-0 bg-linear-to-br from-brand-sky/25 via-brand-stem to-ink-950 opacity-80 [background-image:linear-gradient(rgba(248,243,240,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(248,243,240,0.08)_1px,transparent_1px)] [background-size:36px_36px]"
                    aria-hidden="true"
                />
            )}

            <div className="pointer-events-none absolute inset-0 bg-ink-950/45" aria-hidden="true" />
            <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-ink-950/95 via-brand-stem/75 to-ink-950/15" aria-hidden="true" />
            <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-ink-950/50 via-transparent to-ink-950/20" aria-hidden="true" />
            ...
            <SiteContainer className="relative z-10 flex min-h-[420px] items-center py-12 sm:min-h-[450px] sm:py-14 lg:min-h-[480px] lg:py-16">
                <div className="max-w-xl lg:max-w-2xl">
                    ...
                    <h1 className="mt-5 font-serif text-4xl font-bold leading-[1.02] tracking-[-0.045em] text-brand-plate sm:text-5xl lg:text-6xl">
