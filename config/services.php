...
return [
    ...
    */
    ...
    'hardcover' => [
        ...
        'relationship_limit' => (int) env('HARDCOVER_RELATIONSHIP_LIMIT', 40),
    ...
    'comic_vine' => [
        ...
        'relationship_enrichment_limit' => (int) env('COMIC_VINE_RELATIONSHIP_ENRICHMENT_LIMIT', 4),
        'relationship_limit' => (int) env('COMIC_VINE_RELATIONSHIP_LIMIT', 100),
